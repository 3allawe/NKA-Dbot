...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['ahelp','Type ahelp','Developed by Noname'];
    var i = -1;
    var j = 0;
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`http://www.twitch.tv/agxpro`);
    }, ms);
...
${prefix}bot/To show information about the bot
${prefix}count/To show the number of members in the server without showing the number of bots
${prefix}invites/ To show your own number of invites in the server 
${prefix}invinfo <invitelink here> / To show invite info
 Example : invinfo m82n8P
${prefix}invite-codes/To show your invite links or code
${prefix}cal/Calculator
${prefix}trans <language> <any thing>/To translate any speech from language to another language
${prefix}short/To shortcut links
${prefix}tag/To decorate words
${prefix}google/To search with google in discord
${prefix}perms/To show your permissions in the server
${prefix}z5rf/To decorate words
${prefix}rooms/To show the numbers of rooms in the server
${prefix}roles/To show all the roles of the server 
${prefix}emojilist/To show all the emojis in the server
${prefix}say/To repeat your text
${prefix}image/To show the server's avatar
${prefix}members/To show the status of every member in the server , the number of bots and the number of members
${prefix}id/Information about you
${prefix}bans / To show the number of banned members 
${prefix}avatar/To show your own avatar or another member avatar
${prefix}embed/To repeat your text but decorated
${prefix}emoji <any things>/To change anyword you say to emoji
${prefix}inv/To invite the bot to your server
${prefix}support/The support server
${prefix}contact/To conatact to the owner of bot
**
  `
,`
        ***__Administrative Orders__***
**
${prefix}move @user /  To move user to your room
${prefix}bc / To send a brodcast massege
${prefix}bk / To send a brodcast massege with
${prefix}rolebc <everyone or @role> / To send a brodcast massege to a specific role
${prefix}role @user <rank> / To give a role to user
${prefix}roleremove @user <rank> / To remove a role from a user
${prefix}give all <rank> / To give a role to all users
${prefix}give humans <rank> / To give a role to users only without bots
${prefix}give bots <rank> / To give a role to all bots
${prefix}hchannel / To hide the chat channel
${prefix}schannel / To show the hidden chat channel
${prefix}clr <numbr> / To purge the chat with with a specific number of masseges
${prefix}clear / To purge the chat
${prefix}mute @user <time> / To give a user mute 
${prefix}unmute @user / To unmute a user
${prefix}kick @user <reason> / To kick a user from the server
${prefix}ban @user <reason> / To ban a user from the server
${prefix}mutechannel / To mute a channel 
${prefix}unmutechannel / To unmute a channel
${prefix}dc / To delete all the rooms
${prefix}dr / To delete all the roles
${prefix}ct <name> / To create a text channel
${prefix}cv <name> / To create a voice channel
${prefix}temp / To create a temporary room
${prefix}delet <name> / To delete a text or voice channel
${prefix}make <number> / To create a role color
${prefix}color <number> / To pick a color
${prefix}deletecolors <number> / To delete the color
**
   `,`
        ***__Music orders__***
**
${prefix}play / To play music/a song with link or name
${prefix}skip / To skip the current song
${prefix}pause / To pause the song
${prefix}resume / To resume the song
${prefix}vol / To change the volume from 0-100
${prefix}stop / To stop the bot
${prefix}np / To know the current song is playing
${prefix}queue / To know the playlist 
**
        ***__Games orders__***
 **       
${prefix}rps / Rock paper scissors
${prefix}speed / Type race
${prefix}quas / Question game
${prefix}نكت / نكت 
${prefix}لعبة فكك / فكك
${prefix}عواصم عشوائي/عواصم
${prefix}لعبة كت تويت / كت تويت
${prefix}roll <number> / To make a roll
